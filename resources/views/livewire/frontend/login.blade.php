                ...
                <div class="col-lg-6">
                    <div class="account-login-inner">
                        <form action="{{ route('login') }}" method="POST" class="ltn__form-box contact-form-box">
                            ...
                            @csrf
                            <input class="custom-search" required type="text" :value="old('email')" name="email" placeholder="Email*">

                            <input class="custom-search" required type="password" name="password" placeholder="Password*">
