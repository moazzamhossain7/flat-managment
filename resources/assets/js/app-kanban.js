$(document).ready(function () {
  ...
  var kanban_board_data = [{
    ...
    },
    {
      ...
      border: "info",
      image:  "/assets/img/banner-21.jpg",
      dueDate: "Feb 10"
    },
    {
      id: "13",
  ...
  for (kanban_data in kanban_board_data) {
    ...
    for (kanban_item in kanban_board_data[kanban_data].item) {
      ...
      if (typeof $(board_item_el).attr("data-dueDate") !== "undefined") {
        board_item_dueDate =
          '<div class="kanban-due-date me-2">' +
          '<i class="bx bx-stopwatch font-size-small me-2"></i>' +
      ...
      if (typeof $(board_item_el).attr("data-comment") !== "undefined") {
        board_item_comment =
          '<div class="kanban-comment me-2">' +
          '<i class="bx bx-message font-size-small me-2"></i>' +
          '<span class="font-size-small">' +
      ...
      if (typeof $(board_item_el).attr("data-attachment") !== "undefined") {
        board_item_attachment =
          ...
          '<i class="bx bx-link font-size-small me-2"></i>' +
          '<span class="font-size-small">' +
  ...
  addBoardDefault.addEventListener("click", function () {
    ...
    if (kanbanNewBoard) {
      ...
      kanbanNewBoardData =
        ...
        '<a class="dropdown-item" href="#"><i class="bx bx-link me-2"></i>Copy Link</a>' +
        '<a class="dropdown-item kanban-delete" id="kanban-delete" href="#"><i class="bx bx-trash me-2"></i>Delete</a>' +
        "</div>" + "</div>";
  ...
  function dropdown() {
    kanban_dropdown.innerHTML =
      ...
      '<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton"> ' +
      '<a class="dropdown-item" href="#"><i class="bx bx-link me-2"></i>Copy Link</a>' +
      '<a class="dropdown-item kanban-delete" id="kanban-delete" href="#"><i class="ft-trash-2 me-2"></i>Delete</a>' +
      "</div>";
